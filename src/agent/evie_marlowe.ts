...
const SYSTEM_MESSAGES: SystemMessage[] = [
  new SystemMessage(evieData.systemPrompt),
];
...
export const politeMask = (state: State) =>
  runEmotionalNode(state, evieData.nodes.POLITE_MASK);

export const warySoftening = (state: State) =>
  runEmotionalNode(state, evieData.nodes.WARY_SOFTENING);

export const bitterRemembering = (state: State) =>
  runEmotionalNode(state, evieData.nodes.BITTER_REMEMBERING);

export const defensiveDenial = (state: State) =>
  runEmotionalNode(state, evieData.nodes.DEFENSIVE_DENIAL);

export const evidencePressure = (state: State) =>
  runEmotionalNode(state, evieData.nodes.EVIDENCE_PRESSURE);

export const guardedDisclosure = (state: State) =>
  runEmotionalNode(state, evieData.nodes.GUARDED_DISCLOSURE);

export const fearSpike = (state: State) =>
  runEmotionalNode(state, evieData.nodes.FEAR_SPIKE);

export const brokenTrusting = (state: State) =>
  runEmotionalNode(state, evieData.nodes.BROKEN_TRUSTING);

export const protectedWitness = (state: State) =>
  runEmotionalNode(state, evieData.nodes.PROTECTED_WITNESS);

export const corneredConfession = (state: State) =>
  runEmotionalNode(state, evieData.nodes.CORNERED_CONFESSION);

export const coldShutdown = (state: State) =>
  runEmotionalNode(state, evieData.nodes.COLD_SHUTDOWN);

export const panickedResistance = (state: State) =>
  runEmotionalNode(state, evieData.nodes.PANICKED_RESISTANCE);
